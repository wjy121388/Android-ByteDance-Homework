...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator) {
        ...
        priorityBox = itemView.findViewById(R.id.priority_box);
    }
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority()){
            case 0:
                priorityBox.setBackgroundColor(Color.WHITE);
                break;
            case 1:
                priorityBox.setBackgroundColor(Color.rgb(255,192,203));
                break;
            case 2:
                priorityBox.setBackgroundColor(Color.rgb(220,20,60));
                break;
            default:
                priorityBox.setBackgroundColor(Color.WHITE);
        }
        ...
        priorityBox.post(new Runnable() {
            @Override
            public void run() {
                priorityBox.setHeight(contentText.getHeight()+dateText.getHeight());
            }
        });
        //Log.d(TAG, "bind: contentHeight =  "+contentText.getHeight() +",dateHeight = "+dateText.getHeight());
